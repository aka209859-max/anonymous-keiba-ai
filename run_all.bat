...
echo ============================================================================= > %LOG_FILE%
echo 地方競馬AI予想システム 一括実行 >> %LOG_FILE%
echo ============================================================================= >> %LOG_FILE%
echo 競馬場: %KEIBAJO_NAME% (%KEIBAJO_CODE%) >> %LOG_FILE%
echo 開催日: %TARGET_DATE% >> %LOG_FILE%
...
echo [Phase 0] データ取得中... >> %LOG_FILE%
python scripts\phase0_data_acquisition\extract_race_data.py --keibajo %KEIBAJO_CODE% --date %TARGET_DATE% >> %LOG_FILE% 2>&1
if errorlevel 1 (
    echo [ERROR] Phase 0 でエラーが発生しました。 >> %LOG_FILE%
    echo [ERROR] Phase 0 でエラーが発生しました。
    exit /b 1
)
echo [Phase 0] 完了 >> %LOG_FILE%
echo.

REM Phase 1: 特徴量作成
echo [Phase 1] 特徴量作成中...
echo [Phase 1] 特徴量作成中... >> %LOG_FILE%
...
if errorlevel 1 (
    echo [ERROR] Phase 1 でエラーが発生しました。 >> %LOG_FILE%
    echo [ERROR] Phase 1 でエラーが発生しました。
    exit /b 1
)
echo [Phase 1] 完了 >> %LOG_FILE%
echo.

REM Phase 3: 二値分類予測
echo [Phase 3] 二値分類予測中...
echo [Phase 3] 二値分類予測中... >> %LOG_FILE%
...
if errorlevel 1 (
    echo [ERROR] Phase 3 でエラーが発生しました。 >> %LOG_FILE%
    echo [ERROR] Phase 3 でエラーが発生しました。
    exit /b 1
)
echo [Phase 3] 完了 >> %LOG_FILE%
echo.

REM Phase 4-1: ランキング予測
echo [Phase 4-1] ランキング予測中...
echo [Phase 4-1] ランキング予測中... >> %LOG_FILE%
...
if errorlevel 1 (
    echo [ERROR] Phase 4-1 でエラーが発生しました。 >> %LOG_FILE%
    echo [ERROR] Phase 4-1 でエラーが発生しました。
    exit /b 1
)
echo [Phase 4-1] 完了 >> %LOG_FILE%
echo.

REM Phase 4-2: 回帰予測
echo [Phase 4-2] 回帰予測中...
echo [Phase 4-2] 回帰予測中... >> %LOG_FILE%
...
if errorlevel 1 (
    echo [ERROR] Phase 4-2 でエラーが発生しました。 >> %LOG_FILE%
    echo [ERROR] Phase 4-2 でエラーが発生しました。
    exit /b 1
)
echo [Phase 4-2] 完了 >> %LOG_FILE%
echo.

REM Phase 5: アンサンブル統合
echo [Phase 5] アンサンブル統合中...
echo [Phase 5] アンサンブル統合中... >> %LOG_FILE%
...
if errorlevel 1 (
    echo [ERROR] Phase 5 でエラーが発生しました。 >> %LOG_FILE%
    echo [ERROR] Phase 5 でエラーが発生しました。
    exit /b 1
)
echo [Phase 5] 完了 >> %LOG_FILE%
echo.

REM 配信用テキスト生成
echo [配信用テキスト] 生成中...
echo [配信用テキスト] 生成中... >> %LOG_FILE%
...
if errorlevel 1 (
    echo [ERROR] 配信用テキスト生成でエラーが発生しました。 >> %LOG_FILE%
    echo [ERROR] 配信用テキスト生成でエラーが発生しました。
    exit /b 1
)
echo [配信用テキスト] 完了 >> %LOG_FILE%
echo.
