...
REM ============================================================
REM Phase 6: 配信用テキスト生成（直接Python実行）
REM ============================================================
echo ============================================================
echo [Phase 6] 配信用テキスト生成
echo ============================================================
echo.
...
python scripts\phase6_betting\generate_distribution_note.py "%OUTPUT_ENSEMBLE%" "%NOTE_TXT%"
if errorlevel 1 (
...
python scripts\phase6_betting\generate_distribution_bookers.py "%OUTPUT_ENSEMBLE%" "%BOOKERS_TXT%"
if errorlevel 1 (
...
python scripts\phase6_betting\generate_distribution_tweet.py "%OUTPUT_ENSEMBLE%" "%TWEET_TXT%"
if errorlevel 1 (
...
echo   - 配信用テキスト: %NOTE_TXT%
echo   - 配信用テキスト: %BOOKERS_TXT%
echo   - 配信用テキスト: %TWEET_TXT%
echo.
echo To open:
