...
開催中の各競馬場について、以下の2つのファイルが生成されます:

1. **Note用**: `predictions/{競馬場名}_20260208_note.txt`
2. **ブッカーズ用**: `predictions/{競馬場名}_20260208_bookers.txt`

**例（2026年2月8日に佐賀・大井・川崎が開催の場合）:**
- `佐賀_20260208_note.txt` + `佐賀_20260208_bookers.txt`
- `大井_20260208_note.txt` + `大井_20260208_bookers.txt`
- `川崎_20260208_note.txt` + `川崎_20260208_bookers.txt`

→ **合計: 3競馬場 × 2種類 = 6ファイル** が自動生成
