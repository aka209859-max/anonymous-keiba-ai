...
set "X_ARTICLE_TXT=predictions\!KEIBA_NAME!_!DATE_SHORT!_x_article.txt"
...
REM x_article.txt 生成
echo [4/4] Generating x_article.txt...
python scripts\phase6_betting\generate_distribution_x_article.py "!ENSEMBLE_CSV!" "!X_ARTICLE_TXT!"
if !errorlevel! neq 0 (
    echo [ERROR] Failed to generate x_article.txt
    exit /b 1
)
if not exist "!X_ARTICLE_TXT!" (
    echo [ERROR] x_article.txt was not created
    exit /b 1
)
echo [OK] x_article.txt created
