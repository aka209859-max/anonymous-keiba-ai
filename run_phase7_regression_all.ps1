# ============================================================================
# Phase 7 Regression 特徴量選択 一括実行スクリプト
# ============================================================================
# 作成日: 2026-02-11
# 目的: 残り13会場のRegression特徴量選択を一括実行
# 推定時間: 2〜4時間
# ============================================================================

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Phase 7 Regression 一括実行開始" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Phase 7 Regression 一括実行完了" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
Get-ChildItem data\features\selected\*_regression_selected_features.csv | ForEach-Object {
    Write-Host "  ✅ $($_.Name)" -ForegroundColor Green
}

Write-Host ""
Write-Host "次のステップ: Phase 8 Ranking を実行してください" -ForegroundColor Cyan
Write-Host "実行コマンド: .\run_phase8_ranking_all.ps1" -ForegroundColor Yellow
